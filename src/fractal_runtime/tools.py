...
Ported from huggingface/tau ``tau_agent/tools.py`` v0.4.1 (MIT), unmodified
apart from import paths. This module is the framework on which the manifest
interception surface (fractal_runtime.file_tools, AM-0.1-05) is built.
"""
...
from fractal_runtime.messages import ImageContent, TextContent, ToolCall, WireModel
